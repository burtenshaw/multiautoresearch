...
METHOD_NAME = "task_balanced_sft"


def build_task_balanced_train_mixture() -> TaskMixture:
    """Match SFT task-family mass to the eval score's equal task weighting."""
    return TaskMixture(
        [
            ...
            SyntheticToolTask("train", TRAIN_GENERATIVE_EXAMPLES // 2, seed=37),
            SyntheticChoiceTask("train", TRAIN_CHOICE_EXAMPLES, seed=47),
            SyntheticChoiceTask("train", TRAIN_CHOICE_EXAMPLES, seed=53),
            SyntheticChoiceTask("train", TRAIN_CHOICE_EXAMPLES, seed=59),
            SyntheticChoiceTask("train", TRAIN_CHOICE_EXAMPLES, seed=61),
        ],
        seed=SEED,
    )
...
def run_sft(
    ...
    train_task = build_task_balanced_train_mixture()
    ...
    print(
        ...
        f"generative={TRAIN_GENERATIVE_EXAMPLES:,} "
        f"tool={TRAIN_GENERATIVE_EXAMPLES:,} "
        f"choice={TRAIN_GENERATIVE_EXAMPLES:,}"
    )
